...
export const projects: Project[] = [
  ...
  },
  {
    ...
    company: 'Megaurbix',
    description:
      'Miembro cofundador de la empresa Megaurbix, donde participo en la creación y evolución de soluciones digitales. Responsable del desarrollo web y del mantenimiento.',
    mainPhoto: '/imgs/projects/megaurbix.png',
    photos: [],
    status: 'public',
    link: 'https://megaurbix.com',
    duration: 'mayo 2025 - actualidad',
    role: 'Cofundador y Desarrollador Web',
    technologies: [
      { name: 'React', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg' },
      { name: 'Next.js', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg' },
      { name: 'TypeScript', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/typescript/typescript-original.svg' },
  ...
  },
  {
    ...
    company: 'Bitel',
    description:
      'Sistema de gestión de transcripciones de audios y análisis profundos con integración de IA para la compañía Bitel en Perú.',
    mainPhoto: '/imgs/projects/qacalls.png',
    photos: [],
    status: 'private',
    duration: '1 mes',
    role: 'FullStack',
    technologies: [
      ...
      { name: 'PostgreSQL', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg' },
      { name: 'GitHub', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/github/github-original.svg' },
      { name: 'Whisper', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/openai/openai-original.svg' },
      { name: 'OpenRouter', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/network/network-original.svg' },
    ],
  },
  {
    id: '21',
    ...
    company: 'SANIKING',
    description:
      'Desarrollador del sitio web oficial de la empresa SANIKING, la cual ofrece una alta gama de servicios complementarios, como limpieza, mantenimiento y jardinería.',
    mainPhoto: '/imgs/projects/saniking.png',
    photos: [],
    status: 'public',
    link: 'https://saniking.com.mx',
    duration: '1 mes',
    role: 'Desarrollador web',
    technologies: [
      { name: 'React', icon: 'https://cdn.jsdelivr.net/gh/devicons/devicon/icons/react/react-original.svg' },
